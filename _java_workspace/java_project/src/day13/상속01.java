...
public class 상속01 {
	...
	public static void main(String[] args) {
		...
		b.setB(200);
		b.setC(300);
		b.num= 1000; //접근제어자가 protected이기때문에 직접 접근 가능
		b.print();
		System.out.println("----------------");
		b.setD(15);
		b.setE(25);
...
class B extends A{//자식클래스
	...
	//Override(오버라이드) :부모의 메서드를 재 정의하여 사용하는 것.
	//super : 부모의 값을 가져올때 사용하는 키워드
	@Override
	public void print() {
		//a b c num
		super.print();//부모의 print()method를 호출하여 출력
