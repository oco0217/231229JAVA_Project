...
(function(w) {
    ...
    try {
        var links = ["https:\/\/mat.adpies.com\/mat\/init?oaid=ecd503d6ee1f24d5c2daf75b0ff5c8f2\u0026landing=https%3A%2F%2Fastg.widerplanet.com%2Fdelivery%2Fwpp.php%3Fwpg%3Dadpies_rtb%26oaid%3Decd503d6ee1f24d5c2daf75b0ff5c8f2","https:\/\/cm.g.doubleclick.net\/pixel?google_nid=wider_planet\u0026google_cm\u0026google_ula=12153253,1711612140\u0026poaid=ecd503d6ee1f24d5c2daf75b0ff5c8f2","https:\/\/cm-exchange.toast.com\/bi\/pixel?cm_pid=1107948209\u0026puid=ecd503d6ee1f24d5c2daf75b0ff5c8f2\u0026toast_push"],
            len = links.length,
            i;
        for (i=0; i<len; i++) {
            doPair(links[i]);
...
(function() {
var ttd = new Image();
ttd.src = "https:\/\/match.adsrvr.org\/track\/cmf\/generic?ttd_pid=ven6wdk\u0026ttd_tpi=1\u0026ttd_puid=ecd503d6ee1f24d5c2daf75b0ff5c8f2";
})();
/*]]>*/
...
(function(w) {
    try {
        ...
        if (wp_uid) {
            ...
            if (is_wp_uid) {
                identity.setCookie('_wp_uid', "2-ecd503d6ee1f24d5c2daf75b0ff5c8f2-s1702476018.985|mac_osx|chrome-25awg9", 365);
                return;
            }
        }
