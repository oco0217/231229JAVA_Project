...
public class WordManager {
	...
	public void wordTextPrint() throws IOException { //내보내기
		
			
		FileWriter fw = new FileWriter("D:\\ChanWoong\\words.txt");
		
		
		ArrayList<String> list = new ArrayList<>(words.keySet());
		Collections.sort(list);
		for(String s : list) {
			fw.write(s +" : "+words.get(s)+"\n");
		}
		if(fw != null) {
			fw.close();	
		}
		...
		System.out.println("단어 파일 출력 완료");
	}
